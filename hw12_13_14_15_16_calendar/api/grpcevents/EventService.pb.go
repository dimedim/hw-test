...
const file_EventService_proto_rawDesc = "" +
	"\n" +
	"\x12EventService.proto\x12\x05event\"\x17\n" +
	"\x05Event\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id2,\n" +
	"\x04Todo\x12$\n" +
	"\x04TODO\x12\f.event.Event\x1a\f.event.Event\"\x00BPZNgithub.com/dimedim/hw-test/hw12_13_14_15_16_calendar/api/grpcevents;grpceventsb\x06proto3"
...
var file_EventService_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_EventService_proto_goTypes = []any{
	(*Event)(nil), // 0: event.Event
}
var file_EventService_proto_depIdxs = []int32{
	0, // 0: event.Todo.TODO:input_type -> event.Event
	0, // 1: event.Todo.TODO:output_type -> event.Event
